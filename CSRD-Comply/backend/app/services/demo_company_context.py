...
def build_demo_kpis(company: Company, reporting_year: int) -> dict[str, Any]:
    ...
    extended: dict[str, Any] = {
        ...
        "survey_participation_pct": _r(71 + 2 * min(scale, 1)),
        "focus_group_attendance_pct": _r(62 + 3 * min(scale, 1)),
        "consultation_response_rate_pct": _r(78 + 2 * min(scale, 1)),
        "training_completion_pct": _r(88 + 2 * min(scale, 1)),
