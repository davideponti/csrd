...
- Cookie e tecnologie di tracciamento (vedi Sezione 8)
...
| Assisterenza tecnica e customer support | Esecuzione del contratto |
...
Conserviamo i dati personali per il tempo necessario a soddisfare le finalità per cui sono stati raccolti, in particolare:
- **Dati del profilo**: per tutta la durata dell'abbonamento
- **Report e documenti**: fino a 5 anni dopo la scadenza dell'abbonamento (per conformità normativa)
